<?php
	...
	$query ='select nom,prenom,nbChambres,nbSdB,nbCuisines,nbGarages,nbCaves,surface,tailleTerrain,nbEtages,nbAscenceurs,nomQuartier,typeBien,dateInitiale from bien_immobilier bi natural join utilisateur u where u.idUtilisateur = bi.idUtilisateur';
